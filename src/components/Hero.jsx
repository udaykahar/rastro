        ...
        <div className='text-white hero '>
            <div className='max-w-[800px] w-full h-screen text-center flex flex-col justify-center mt-[-96px] mx-auto px-2 md:px-0'>
                ...
                <div className='flex  justify-center items-center'>
                    ...
                    <Typed className='sm:text-4xl text-xl font-bold pl-2 text-[#ff7010]' strings={['Life decesions', 'Relationships', 'Destiny','Self-Growth']} typeSpeed={40} backSpeed={50} loop />
                </div>
                ...
                <button className='bg-[#ff7010] text-white text-2xl font-bold py-4 px-8 rounded-md mt-8 w-[280px] mx-auto'>Book Appointment</button>
            </div>
        </div>
    )
}
